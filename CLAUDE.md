...
**Morning Brief**: Daily 8:00 AM Telegram brief via host crontab (`~/homelab/scripts/morning-brief.sh`). Sources: Google Calendar OAuth2 (Workspace account), wttr.in, La Brújula 24 RSS, La Nación RSS, TechCrunch RSS, docker-quick.js. OAuth2 credentials at `~/.config/secrets/gcal_oauth.json`.
